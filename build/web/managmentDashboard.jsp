                        ...
                        <li> <div class="panel panel-default">
                                ...
                                <div id="collapseFirst" class="panel-collapse collapse in">
                                    ...
                                    <div class="panel-heading">
                                      <h4 class="panel-title">
                                        <li class="active">
                                         <a id="drop1" role="button" data-toggle="dropdown" href="#">BIM1st <b class="caret"></b></a>
                                   ...
                                   <div class="panel-heading">
                                      <h4 class="panel-title">
                                        <li class="active">
                                         <a id="drop1" role="button" data-toggle="dropdown" href="#">BIM2nd <b class="caret"></b></a>
                                           <ul id="menu1" class="dropdown-menu" role="menu" aria-labelledby="drop4">
                                             <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Principle of Management</a></li>
                                             <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Bausiness Math</a></li>
                                             <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Basic accounting</a></li>
                                    ...
                                    <div class="panel-heading">
                                      <h4 class="panel-title">
                                        <li class="active">
                                         <a id="drop1" role="button" data-toggle="dropdown" href="#">BIM3rd <b class="caret"></b></a>
                                           <ul id="menu1" class="dropdown-menu" role="menu" aria-labelledby="drop4">
                                             <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Principle of Management</a></li>
                                             <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Bausiness Math</a></li>
                                             <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Basic accounting</a></li>
