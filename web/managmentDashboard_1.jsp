        ...
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseBIM1st">
                                BIM1st
                            </a>
                        </h4>
                    </div>
                    <div id="collapseBIM1st" class="panel-collapse collapse">
                        <div class="panel-body">
                             apple     
                                ball
                                cat
...
<!--                    <div id="collapseBim1st" class="panel-collapse collapse">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseBBS">
                                BBS
                            </a>
                        </h4>
                    </div>
                    <div id="collapseBBS" class="panel-collapse collapse">
                        <div class="panel-body">
                             apple     
                        ball
                        cat
